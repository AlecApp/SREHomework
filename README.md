...
**Side Note:** While building the images this warning appeared: **karma-jasmine-html-reporter@1.5.4 has incorrect peer dependency "jasmine-core@>=3.5"** I'm noting it here just in case it becomes relevant to future problems.
